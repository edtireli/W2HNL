...
pT_minimum = '3.0 GeV' # Minimum transverse momentum
...
r_max_l = '7 m' # Maximum distance from interaction point (IP) to consider HNL decays/decay volume in the longitudinal (z) direction along beamline
...
rescaling =  0.89519047 # A factor used to rescale production uniformly accross the parameter space
