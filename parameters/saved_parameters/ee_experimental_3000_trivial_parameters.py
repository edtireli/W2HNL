...
pT_minimum = '4.5 GeV' # Minimum transverse momentum
...
r_max_t = '300 mm' # Maximum distance from interaction point (IP) to consider HNL decays/decay volume in the transverse direction
r_max_l = '500 mm' # Maximum distance from interaction point (IP) to consider HNL decays/decay volume in the longitudinal (z) direction along beamline

luminosity = 3000 # 1/fb
...
rescaling =  0.91193356 # A factor used to rescale production uniformly accross the parameter space
